...
#' 
#' #### piggyback ####  
#' tmp <- file.path(tempdir(),"CORCES_2020.hichip_fithichip_loop_calls.tsv.gz")
#' data.table::fwrite(CORCES_2020.hichip_fithichip_loop_calls,tmp,sep="\t")
#' piggyback::pb_upload(file = tmp,
#'                      repo = "RajLabMSSM/echoannot")
#' } 
#' @export
get_CORCES_2020.hichip_fithichip_loop_calls <- function(){
    tmp <- get_data(fname = "CORCES_2020.hichip_fithichip_loop_calls.tsv.gz")
