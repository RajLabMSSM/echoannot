...
Prepare data to plot overlap between
[data.table](https://rdrr.io/pkg/data.table/man/data.table.html) of SNPs
and cell-type-specific epigenomic peaks and coaccessibility data.
